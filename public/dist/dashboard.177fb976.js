...
})({"a8uat":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "40b06f02177fb976";
"use strict";
...
},{}],"1Mu3k":[function(require,module,exports) {
...
const idValidated = async (url = `year=${new Date().getFullYear()}`, lists = monthLists, type = "year")=>{
    try {
        ...
        if (type === "year") dataAPI.data.forEach((log)=>{
            dataList[lists[log.month - 1]] = log.count;
        });
        else if (type === "month") dataAPI.data.forEach((log)=>{
            dataList[lists[log.day - 1]] = log.count;
        });
        else if (type === "hour") dataAPI.data.forEach((log)=>{
        ...
        idValidatedGraph = new (0, _autoDefault.default)(ctx, {
            type: "bar",
            data: {
                labels: lists,
                datasets: [
                ...
                datasets: [
                    {
                        ...
                        data: [
                            enrolledAPI.data.count,
                            validatedAPI.data.count
                        ],
                        backgroundColor: [
                            "rgb(107, 45, 168)",
                            "rgb(144, 68, 220)"
...
},{}]},["a8uat","1Mu3k"], "1Mu3k", "parcelRequirebb82")
